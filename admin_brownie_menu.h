...
namespace try3 {
	...
	/// <summary>
	/// Summary for admin_brownie_menu
	/// </summary>
	public ref class admin_brownie_menu : public System::Windows::Forms::Form
	{
	public:
		admin_brownie_menu(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(admin_brownie_menu::typeid));
			...
			this->button16->Click += gcnew System::EventHandler(this, &admin_brownie_menu::button16_Click);
			// 
			// button11
			// 
			...
			this->button11->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(207)), static_cast<System::Int32>(static_cast<System::Byte>(234)),
				static_cast<System::Int32>(static_cast<System::Byte>(241)));
			this->button11->Location = System::Drawing::Point(1306, 327);
			this->button11->Name = L"button11";
			this->button11->Size = System::Drawing::Size(193, 43);
			this->button11->TabIndex = 57;
			this->button11->Text = L"Update Quantity";
			this->button11->UseVisualStyleBackColor = false;
			this->button11->Click += gcnew System::EventHandler(this, &admin_brownie_menu::button11_Click);
			// 
			// button9
			// 
			...
			this->button9->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(207)), static_cast<System::Int32>(static_cast<System::Byte>(234)),
				static_cast<System::Int32>(static_cast<System::Byte>(241)));
			this->button9->Location = System::Drawing::Point(1306, 542);
			this->button9->Name = L"button9";
			this->button9->Size = System::Drawing::Size(193, 43);
			this->button9->TabIndex = 56;
			this->button9->Text = L"Update Quantity";
			this->button9->UseVisualStyleBackColor = false;
			this->button9->Click += gcnew System::EventHandler(this, &admin_brownie_menu::button9_Click);
			// 
			// button7
			// 
			...
			this->button7->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(207)), static_cast<System::Int32>(static_cast<System::Byte>(234)),
				static_cast<System::Int32>(static_cast<System::Byte>(241)));
			this->button7->Location = System::Drawing::Point(1306, 741);
			this->button7->Name = L"button7";
			this->button7->Size = System::Drawing::Size(193, 43);
			this->button7->TabIndex = 55;
			this->button7->Text = L"Update Quantity";
			this->button7->UseVisualStyleBackColor = false;
			this->button7->Click += gcnew System::EventHandler(this, &admin_brownie_menu::button7_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &admin_brownie_menu::button4_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &admin_brownie_menu::button2_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &admin_brownie_menu::button5_Click);
			// 
			// admin_brownie_menu
			// 
			...
			this->Name = L"admin_brownie_menu";
			this->Text = L"admin_brownie_menu";
