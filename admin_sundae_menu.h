...
namespace try3 {
	...
	/// <summary>
	/// Summary for admin_sundae_menu
	/// </summary>
	public ref class admin_sundae_menu : public System::Windows::Forms::Form
	{
	public:
		admin_sundae_menu(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(admin_sundae_menu::typeid));
			...
			this->button16->Click += gcnew System::EventHandler(this, &admin_sundae_menu::button16_Click);
			// 
			// button11
			// 
			...
			this->button11->Click += gcnew System::EventHandler(this, &admin_sundae_menu::button11_Click);
			// 
			// button9
			// 
			...
			this->button9->Click += gcnew System::EventHandler(this, &admin_sundae_menu::button9_Click);
			// 
			// button7
			// 
			...
			this->button7->Click += gcnew System::EventHandler(this, &admin_sundae_menu::button7_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &admin_sundae_menu::button4_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &admin_sundae_menu::button2_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &admin_sundae_menu::button5_Click);
			// 
			// admin_sundae_menu
			// 
			...
			this->Name = L"admin_sundae_menu";
			this->Text = L"admin_sundae_menu";
