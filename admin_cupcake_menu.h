...
namespace try3 {
	...
	/// <summary>
	/// Summary for admin_cupcake_menu
	/// </summary>
	public ref class admin_cupcake_menu : public System::Windows::Forms::Form
	{
	public:
		admin_cupcake_menu(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(admin_cupcake_menu::typeid));
			...
			this->button16->Click += gcnew System::EventHandler(this, &admin_cupcake_menu::button16_Click);
			// 
			// button11
			// 
			...
			this->button11->Click += gcnew System::EventHandler(this, &admin_cupcake_menu::button11_Click);
			// 
			// button9
			// 
			...
			this->button9->Click += gcnew System::EventHandler(this, &admin_cupcake_menu::button9_Click);
			// 
			// button7
			// 
			...
			this->button7->Click += gcnew System::EventHandler(this, &admin_cupcake_menu::button7_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &admin_cupcake_menu::button4_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &admin_cupcake_menu::button2_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &admin_cupcake_menu::button5_Click);
			// 
			// admin_cupcake_menu
			// 
			...
			this->Name = L"admin_cupcake_menu";
			this->Text = L"Update Quantity";
