...
namespace try3 {
	...
	/// <summary>
	/// Summary for Admin_SignUp
	/// </summary>
	public ref class Admin_SignUp : public System::Windows::Forms::Form
	{
	public:
		Admin_SignUp(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Admin_SignUp::typeid));
			...
			this->button1->Click += gcnew System::EventHandler(this, &Admin_SignUp::button1_Click_1);
			// 
			// textBox3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &Admin_SignUp::button3_Click_1);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &Admin_SignUp::button2_Click_1);
			// 
			// panel1
			// 
			...
			this->textBox2->KeyDown += gcnew System::Windows::Forms::KeyEventHandler(this, &Admin_SignUp::textBox2_KeyDown_1);
			// 
			// panel3
			// 
			...
			this->textBox1->KeyDown += gcnew System::Windows::Forms::KeyEventHandler(this, &Admin_SignUp::textBox1_KeyDown);
			// 
			// label2
			// 
			...
			this->label2->Click += gcnew System::EventHandler(this, &Admin_SignUp::label2_Click_1);
			// 
			// checkBox1
			// 
			...
			this->checkBox1->CheckedChanged += gcnew System::EventHandler(this, &Admin_SignUp::checkBox1_CheckedChanged_1);
			// 
			// panel2
			// 
			...
			this->textBox4->KeyDown += gcnew System::Windows::Forms::KeyEventHandler(this, &Admin_SignUp::textBox4_KeyDown);
			// 
			// Admin_SignUp
			// 
			...
			this->Name = L"Admin_SignUp";
			this->Text = L"Admin_SignUp";
