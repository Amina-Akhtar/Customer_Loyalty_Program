...
namespace try3 {
	...
	/// <summary>
	/// Summary for EndForm_Negative
	/// </summary>
	public ref class EndForm_Negative : public System::Windows::Forms::Form
	{
	public:
		EndForm_Negative(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(EndForm_Negative::typeid));
			...
			this->button5->Click += gcnew System::EventHandler(this, &EndForm_Negative::button5_Click);
			// 
			// EndForm_Negative
			// 
			...
			this->Name = L"EndForm_Negative";
			this->Text = L"EndForm_Negative";
