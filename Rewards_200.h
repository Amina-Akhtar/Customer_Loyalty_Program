...
namespace try3 {
	...
	/// <summary>
	/// Summary for Rewards_200
	/// </summary>
	public ref class Rewards_200 : public System::Windows::Forms::Form
	{
	public:
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Rewards_200::typeid));
			...
			this->button1->Location = System::Drawing::Point(716, 528);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(190, 46);
			this->button1->TabIndex = 5;
			this->button1->Text = L"Redeem";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &Rewards_200::button1_Click);
			// 
			// button3
			// 
			...
			this->button3->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(207)), static_cast<System::Int32>(static_cast<System::Byte>(234)),
				static_cast<System::Int32>(static_cast<System::Byte>(241)));
			this->button3->Location = System::Drawing::Point(716, 791);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(190, 46);
			this->button3->TabIndex = 7;
			this->button3->Text = L"Redeem";
			this->button3->UseVisualStyleBackColor = false;
			this->button3->Click += gcnew System::EventHandler(this, &Rewards_200::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(207)), static_cast<System::Int32>(static_cast<System::Byte>(234)),
				static_cast<System::Int32>(static_cast<System::Byte>(241)));
			this->button2->Location = System::Drawing::Point(1355, 791);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(190, 46);
			this->button2->TabIndex = 9;
			this->button2->Text = L"Redeem";
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &Rewards_200::button2_Click);
			// 
			// button4
			// 
			...
			this->button4->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(207)), static_cast<System::Int32>(static_cast<System::Byte>(234)),
				static_cast<System::Int32>(static_cast<System::Byte>(241)));
			this->button4->Location = System::Drawing::Point(1355, 528);
			this->button4->Name = L"button4";
			this->button4->Size = System::Drawing::Size(190, 46);
			this->button4->TabIndex = 8;
			this->button4->Text = L"Redeem";
			this->button4->UseVisualStyleBackColor = false;
			this->button4->Click += gcnew System::EventHandler(this, &Rewards_200::button4_Click);
			// 
			// button5
			// 
			...
			this->button5->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(185)), static_cast<System::Int32>(static_cast<System::Byte>(163)),
				static_cast<System::Int32>(static_cast<System::Byte>(105)));
			this->button5->Location = System::Drawing::Point(57, 150);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(72, 49);
			this->button5->TabIndex = 10;
			this->button5->Text = L"<";
			this->button5->UseVisualStyleBackColor = false;
			this->button5->Click += gcnew System::EventHandler(this, &Rewards_200::button5_Click);
			// 
			// Rewards_200
			// 
			...
			this->Name = L"Rewards_200";
			this->Text = L"Rewards_200";
