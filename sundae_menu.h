...
namespace try3 {
	...
	/// <summary>
	/// Summary for sundae_menu
	/// </summary>
	public ref class sundae_menu : public System::Windows::Forms::Form
	{
	public:
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(sundae_menu::typeid));
			...
			this->button16->Click += gcnew System::EventHandler(this, &sundae_menu::button16_Click);
			// 
			// button14
			// 
			...
			this->button14->Click += gcnew System::EventHandler(this, &sundae_menu::button14_Click);
			// 
			// button15
			// 
			...
			this->button15->Click += gcnew System::EventHandler(this, &sundae_menu::button15_Click);
			// 
			// button12
			// 
			...
			this->button12->Click += gcnew System::EventHandler(this, &sundae_menu::button12_Click);
			// 
			// button13
			// 
			...
			this->button13->Click += gcnew System::EventHandler(this, &sundae_menu::button13_Click);
			// 
			// button10
			// 
			...
			this->button10->Click += gcnew System::EventHandler(this, &sundae_menu::button10_Click);
			// 
			// button11
			// 
			...
			this->button11->Click += gcnew System::EventHandler(this, &sundae_menu::button11_Click);
			// 
			// button8
			// 
			...
			this->button8->Click += gcnew System::EventHandler(this, &sundae_menu::button8_Click);
			// 
			// button9
			// 
			...
			this->button9->Click += gcnew System::EventHandler(this, &sundae_menu::button9_Click);
			// 
			// button6
			// 
			...
			this->button6->Click += gcnew System::EventHandler(this, &sundae_menu::button6_Click);
			// 
			// button7
			// 
			...
			this->button7->Click += gcnew System::EventHandler(this, &sundae_menu::button7_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &sundae_menu::button5_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &sundae_menu::button1_Click);
			// 
			// sundae_menu
			// 
			...
			this->Name = L"sundae_menu";
			this->Text = L"sundae_menu";
